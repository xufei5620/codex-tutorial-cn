...
**当前版本：** 0.4.0（2026-09-04）。课程正在按内容单元逐条复核、审校与验证；各章进度见下表。

> 2026 年 7 月 9 日起，Codex 桌面应用已并入「ChatGPT 桌面应用」（macOS / Windows）。本教程所说的 Codex，指从 ChatGPT 产品下拉菜单或当前版本提供的产品入口选择的 **Codex**。

| 章 | 标题 | 状态 |
|---|---|---|
| 01 | [开始前：边界、安全与阅读方法](ch01.html) | 已编辑审校 |
| 02 | [认识 AI 与 Codex](ch02.html) | 已编辑审校 |
| 03 | [安装、登录与界面](ch03.html) | 已编辑审校 |
| 04 | [第一次对话：把需求说清楚](ch04.html) | 已编辑审校 |
| 05 | [日常协作：检查、修改与回退](ch05.html) | 已编辑审校 |
| 06 | [插件](ch06.html) | 草稿 |
